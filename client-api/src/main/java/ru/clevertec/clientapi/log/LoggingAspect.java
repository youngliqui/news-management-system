package ru.clevertec.clientapi.log;
...
public class LoggingAspect {
    ...
    @Around("execution(* ru.clevertec.clientapi.controller..*(..))")
    ...
    @Around("execution(* ru.clevertec.clientapi.service..*(..))")
    public Object logServiceAccess(ProceedingJoinPoint joinPoint) throws Throwable {
        return logMethodExecution(joinPoint, "Service");
    }

    @Around("execution(* ru.clevertec.clientapi.repository..*(..))")
